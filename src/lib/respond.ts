...
import { Link, HATEOASResource, generatePaginationLinks } from "./hateoas";
...
export default function Respond(
	...
	if (
		...
		if (res.req && links.length === 0) {
			...
			// Use pathname from originalUrl so nested routers get correct path (e.g. /api/v1/accounting/journal)
			const basePath =
